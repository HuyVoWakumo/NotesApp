...
class _NoteDetailState extends ConsumerState<NoteDetailView> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      onPopInvoked: (value) {
        ref.read(noteDetailProvider).clear();
      },
      child: Scaffold(
        appBar: AppBar(
          actions: [  
            ...
            children: [
              TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: ref.read(noteDetailProvider).titleController.text == '' ? "Title": null,
              ...
              TextFormField(
                ...
                maxLines: null,
                decoration:  InputDecoration(
                  hintText: ref.read(noteDetailProvider).contentController.text == '' ? "Enter something ..." : null,
                  border: InputBorder.none,
                ),
                style: const TextStyle(
                  overflow: TextOverflow.ellipsis
